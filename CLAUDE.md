...
For the planned reconciliation job that sweeps stuck `PENDING` rows, see [../smart-contract-revamp/docs/order-lock-lifecycle-followups.md](../smart-contract-revamp/docs/order-lock-lifecycle-followups.md).
